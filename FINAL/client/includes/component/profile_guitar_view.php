<?php
    ...
    $sql .=" b.part_name as bpartname ,  b.thickness as bthickness , b.description as bdescription , b.image as bimage , b.price as bprice ";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="handlers/forms/payment.php">
            ...
            <div id="containercash" class="hidden">
                ...
                <input type="submit" name="cash" value="Proceed" class="btn btn-warning">
            </div>
            <!-- -->
            ...
            <div id="containerinstallment" class="hidden">
                ...
                <input type="submit" name="installment" value="Proceed" class="btn btn-warning">
            </div>
        </form>
      </div>
