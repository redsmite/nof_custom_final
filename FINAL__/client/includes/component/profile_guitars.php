<?php
    ...
    $sql = "SELECT a.id as guitar_id  ,a.guitar_name as guitar_name , a.* ,(SELECT image from tbl_parts where part_type = '1' and id= a.head_id) as head, 
    ...
    if(!$query->num_rows){
        ...
        while($row = mysqli_fetch_assoc($query)) :
            ...
            <h2><?php echo $row['guitar_name'];?></h2>
